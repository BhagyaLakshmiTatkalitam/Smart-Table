		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Smart table",
									"targetURL": "#smarttablenorthwind-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"smarttablenorthwind-display": {
								"semanticObject": "smarttablenorthwind",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=smarttablenorthwind",
									"url": sap.ui.require.toUrl("smarttablenorthwind")
								}
							}
						}
					}
